...
## Introduction
  ...
  2. Can headline and snippet wording regarding unemployment shed light on other concerns Americans may have?
...
Trust is always high -- the levels are different for each year -- 

## Key Take Aways Regarding Whole Project

### Limitations
The New York Times API is a bit hard to work with in R. I initially desired a larger sample of articles for each year however, I was limited to 10. After 10, the New York Times API results in an error message.
