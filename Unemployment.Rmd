...
word_econ<-filter(total, word.f=="economi")
...
Complete.ts.plot <- ggplot()+
  ...
  geom_line(data=word_rate, aes(x=Year, y=freq), color='pink')+
...
```{r}
econ_08.1 <- gtrends(keyword="economy", time="2008-01-01 2022-12-11",geo="US")
...
unemp <- gtrends(keyword="Unemployment", time="2008-01-01 2022-12-11",geo="US")
